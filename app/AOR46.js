...
export default function AOR46({ navigation }) {
  ...
  const clearInput = () => {
    ...
    switch (currentScreen) {
      ...
      case "RF Config E-Tilt":
        ...
        break;
      case "Bracket":
        temp.bracket = cloneDeep(inputFormat.bracket);
        break;
      case "Full Antenna":
        temp.fullAntenna = cloneDeep(inputFormat.fullAntenna);
        break;
      default:
    ...
    if (!firstSubmit.current) {
      const newErrorScreen = screens.map((screen) => {
        ...
        switch (screen.name) {
          ...
          case "Bracket":
            return foundEmpty(input.bracket);
          case "Full Antenna":
            return foundEmpty(input.fullAntenna);
          default:
            console.error(
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScreenTitle screenName="AOR 4-6 Capture Entry" navigation={navigation} />
